...
/**
 * <p> 描述 : 重写BasicErrorController,主要负责系统的异常页面的处理以及错误信息的显示
...
public class ErrorPagesController implements ErrorController {
    ...
    /**
     * <p> 描述 : 初始化ExceptionController
     * @author : blackcat
     * @date  : 2020/2/2 10:37
    */
    @Autowired
    public ErrorPagesController(ErrorAttributes errorAttributes) {
        Assert.notNull(errorAttributes, "ErrorAttributes 不能为空");

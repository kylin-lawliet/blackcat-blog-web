        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addOrUpdateForm" class="form-horizontal form-label-left" novalidate>
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">角色信息: <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12" name="description" id="description" required="required" placeholder="请输入角色信息"/>
                        </div>
                    </div>
                    <div class="item form-group">
                    ...
                    var setting = {
                        ...
                        callback: {
                            onCheck: function (event, treeId, treeNode) {
                                ...
                                console.log(ids);
                                console.log(rolesId);
                                $.post(options.saveRolesUrl, {"roleId": rolesId, "menuId": ids.join(",")}, function (obj) { }, 'json');
                            }
                        }
                    };
